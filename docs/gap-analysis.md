...
>
> **2026-09-18**：node 层收尾（`10-node-layer.md` 三条未决全清）、多主机验了地基即暂停、
> 新写 `roadmap/12-workspace.md`（终端与文件合成一个工作区）。**最新交接见
> [`HANDOFF-2026-09-18.md`](./HANDOFF-2026-09-18.md)** —— 内含一个**必须先修**的终端退出
> 信号 bug，以及三条「信号说成功、实际没成功」的教训。
>
